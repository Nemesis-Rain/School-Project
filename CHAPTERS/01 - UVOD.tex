...
%todo zadání
%todo max 1 obrázek na stranu
%todo Přejmenovat obrázky
%todo DevKitC -- Upravit zmínky v textu
%todo pinhead
%todo odkaz na knihovny
%todo vyhodit ukazovací zájmena

%todo (viz kapitola \ref{3}) --> otázka na učitele?
%todo Odkazy + Literatura --> Otázka na učitele kdy to je Literatura a kdy odkaz? 
%todo Otázka---> mají být kurzívou i normální použité součástky? 
